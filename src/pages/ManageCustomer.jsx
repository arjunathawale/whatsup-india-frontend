                ...
                <table className="table-auto w-full bg-white shadow-md rounded-lg ">
                    <thead>
                        <tr className="bg-[#084DF0] text-white text-left">
                            ...
                            <th className="px-4 py-2">First Message Time</th>
                            <th className="px-4 py-2">Last Message Time</th>
                                ...
                                paginatedCustomers.map((customer, index) => (
                                    <tr key={customer.id} className="border-b h-max">
                                        ...
                                        <td className="px-4 py-2 text-center">{
                                            customer.subscribed ? <span className='p-1 px-2 bg-green-500 text-xs text-white rounded-lg'>Subscribed</span> :
                                                <span className='p-1 px-2 bg-red-500 text-xs text-white rounded-lg'>UnSubscribed</span>}
                                        </td>
                                    </tr>
                                )) : !loader && <tr>
