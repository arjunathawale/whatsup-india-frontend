...
const AddRequestLocation = ({ botId, isLocationOpen, setIsLocationOpen, data = {}, setCurrentScript, redirectData, getScript }) => {
    ...
    const [formData, setFormData] = useState({
        id: data?._id,
        botId: botId,
        messageType: data?.messageType || "REQUEST_LOCATION",
        ...
        expectedMessage: data?.expectedMessage || "location",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Error in Adding Location Script', error);
        ...
        <div>
            ...
            <div
                className={`
                    ...
                    ${isLocationOpen ? "opacity-100 scale-100" : "opacity-0 scale-90 pointer-events-none"
                    }`}
            >
                ...
                <div className="bg-white w-full max-w-lg mx-4 sm:mx-auto rounded-lg shadow-lg p-6">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-lg font-bold">{Object.keys(data).length ? "Update Location Script" : "Add Location Script"}</h2>
                        <button
                    ...
                    >
                        {Object.keys(data).length ? "Update Location Script" : "Add Location Script"}
                    </button>
                </div>
